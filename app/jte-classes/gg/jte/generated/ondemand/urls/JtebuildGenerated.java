...
public final class JtebuildGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,4,4,4,4,6,6,9,9,22,22,25,25,25,28,28,28,28,28,28,28,28,28,28,28,28,31,31,32,32,32,33,33,36,36,37,37,37,38,38,41,41,45,45,45,45,45,4,4,4,4};
			...
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				for (var url : page.getUrls()) {
					...
					if (page.getLastChecks().get(url.getId()) != null) {
						jteOutput.writeContent("\r\n                                    ");
						jteOutput.setContext("td", null);
						jteOutput.writeUserContent(page.getLastChecks().get(url.getId()).getCreatedAt().toString().substring(0, 16));
						jteOutput.writeContent("\r\n                                ");
					}
					jteOutput.writeContent("\r\n                            </td>\r\n                            <td>\r\n                                ");
					if (page.getLastChecks().get(url.getId()) != null) {
